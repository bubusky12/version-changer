...
const serverTypes: ServerType[] = [
  {
    ...
    icon: <img src="https://api.exluhost.my.id/img/papermc.svg" alt="Paper" className="w-8 h-8" />,
  ...
  },
  {
    ...
    icon: <img src="https://api.exluhost.my.id/img/neoforge.png" alt="Neo Forge" className="w-8 h-8" />,
  ...
  },
  {
    ...
    name: 'Forge',
    description: 'Untuk kebutuhan server dengan menggunakan mods / modspack',
    icon: <img src="https://api.exluhost.my.id/img/forge.jpeg" alt="Forge" className="w-8 h-8 rounded" />,
  ...
  },
  {
    ...
    name: 'Fabric',
    description: 'Untuk kebutuhan server dengan menggunakan mods / modspack',
    icon: <img src="https://api.exluhost.my.id/img/Fabric.png" alt="Fabric" className="w-8 h-8" />,
  ...
  },
  {
    ...
    icon: <img src="https://api.exluhost.my.id/img/papermc.svg" alt="Velocity" className="w-8 h-8" />,
  ...
  },
  {
    ...
    icon: <img src="https://api.exluhost.my.id/img/purpur-small.png" alt="Purpur" className="w-8 h-8" />,
  ...
  },
  {
    ...
    name: 'Mohist',
    description: 'Untuk kebutuhan server dengan menggunakan mods dan plugins secara bersamaan',
    icon: <img src="https://api.exluhost.my.id/img/mohistLogo.png" alt="Mohist" className="w-8 h-8" />,
    color: 'from-purple-400 to-pink-500',
        ...
        const progressInterval = setInterval(() => {
          ...
          if (progress >= 100) {
            ...
            if (needsUnzip) {
              ...
              }, 50000); // Wait 10 seconds before unzipping
            } else {
